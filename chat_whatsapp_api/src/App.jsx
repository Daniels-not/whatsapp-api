...
function App() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if(telephone === '' || Bussines === '' || message === '' || name === ''){
      setAlert('Por favor llene todos los campos')
    }
    else{
      // post data to whatsapp api

      setAlert('Mensaje enviado')
      setAlert('')
      setTelephone('');
      setBussines('');
      setMessage('');
            ...
            <Stack
              ...
              <Box
                ...
                <VStack spacing={5}>
                  ...
                  <FormControl isRequired>
                    <FormLabel>Bussines telephone</FormLabel>
                    ...
                    <InputGroup>
                      ...
                      <Input
                        type="tel"
                        name="telephone"
                        placeholder="Telephone destination"
